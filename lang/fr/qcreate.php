...
$string['addminimumquestionshdr'] = 'Evaluation d\'un nombre minimum de questions du type (optionnel)';
...
$string['allowedqtypes_help'] = 'Here you specify the type of questions that need to be made. If you select \'Allow all question types\', then students can make any type of question up to the total specified in \'Total Questions Graded\'.';
