...
/**
 * This file contains the mod_qcreate useridlist
 *
...
class useridlist {
    ...
    /** @var int The ID of the qcreate object. */
    protected $qcreateid;
     ...
     * @param int $qcreateid The qcreate ID.
     */
    public function __construct($teacherid, $qcreateid) {
        $this->teacherid = $teacherid;
        $this->qcreateid = $qcreateid;
    }
    ...
    /**
     * Returns the qcreate ID.
     *
     * @return int The qcreate ID.
     */
    public function get_qcreateid() {
        return $this->qcreateid;
    }
